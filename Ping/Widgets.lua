...
function Ping:CreateFrame(Name, Title, Height, Width, ShowFunc, HideFunc)
...
--	theFrame.TitleBar = CreateFrame("Frame", "TestFrame", theFrame, "BackdropTemplate")	
	theFrame.TitleBar = CreateFrame("Frame", "PingTitleBarFrame", theFrame, "BackdropTemplate")
	...
	theFrame.Title:SetHeight(Ping.db.profile.MainWindow.TextHeight)
	Ping:AddFontString(theFrame.Title)

	if Name == "Ping_MainWindow" then
		Ping.Colors:UnregisterItem(theFrame.Title)
		Ping.Colors:RegisterFont("Window", "Title Text", theFrame.Title)
	else
		Ping.Colors:UnregisterItem(theFrame.Title)
		Ping.Colors:RegisterFont("Other Windows", "Title Text", theFrame.Title)
	end
