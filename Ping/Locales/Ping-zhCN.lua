local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "zhCN") -- Simplified Chinese
...
L["Ping"] = "Ping 侦测敌方玩家"
L["Version"] = "版本"
L["Ping Option"] = "Ping 侦测敌方玩家"
L["Profiles"] = "Profiles 配置文件"
 
-- About
L["About"] = "信息"
L["PingDescription1"] = [[
Ping 侦测敌方玩家 插件可以提醒您附近有敌对玩家出现。
...
|cffffd000 作者:|cffffffff Oomkill
]]
...
L["EnablePing"] = "开启Ping"
L["EnablePingDescription"] = "启用或禁用Ping。"
L["EnabledInBattlegrounds"] = "战场中启用Ping"
L["EnabledInBattlegroundsDescription"] = "在战场中启用或禁用Ping。"
L["EnabledInArenas"] = "竞技场中启用Ping"
L["EnabledInArenasDescription"] = "在竞技场中启用或禁用Ping。"
L["EnabledInWintergrasp"] = "世界战斗区域中启用Ping"
L["EnabledInWintergraspDescription"] = "在世界战斗区域中启用或禁用Ping，例如诺森德的冬握湖。"
L["EnabledInSanctuaries"] = "Enable Ping in Sanctuaries"
L["EnabledInSanctuariesDescription"] = "Enables or disables Ping when you are in a Sanctuary."L["DisableWhenPVPUnflagged"] = "非PVP状态时禁用Ping"
L["DisableWhenPVPUnflaggedDescription"] = "根据PVP状态启用或禁用Ping。"
L["DisabledInZones"] = "在这些位置时禁用Ping"
L["DisabledInZonesDescription"]	= "选择将禁用Ping的位置"
L["Booty Bay"] = "藏宝海湾"
L["Everlook"] = "永望镇"						
L["Gadgetzan"] = "加基森"
L["Ratchet"] = "棘齿城"
...
L["ShowOnDetection"] = "侦测到敌对玩家时显示Ping"
L["ShowOnDetectionDescription"] = "当侦测到敌对玩家时，自动显示隐藏的Ping菜单和附近列表。"
L["HidePing"] = "未侦测到敌对玩家时隐藏"
L["HidePingDescription"] = "当附近列表为空列表时隐藏Ping，手动清空列表不会隐藏Ping。"
...
L["Alpha"] = "透明度"
L["AlphaDescription"] = "设置Ping窗口的透明度。"
L["AlphaBG"] = "战场上的透明度"
L["AlphaBGDescription"] = "在战场中设置Ping窗口的透明度。"
L["LockPing"] = "锁定Ping窗口"
L["LockPingDescription"] = "锁定Ping窗口无法移动。"
L["ClampToScreen"] = "屏幕锁定"
L["ClampToScreenDescription"] = "控制是否可以将Ping的窗口拖出屏幕。"
L["InvertPing"] = "翻转Ping窗口"
L["InvertPingDescription"] = "上下翻转Ping窗口。"
L["Reload"] = "重新载入"
L["ReloadDescription"] = "调整Ping窗口大小后需重新载入。"
L["ResizePing"] = "自动调整Ping窗口大小"
L["ResizePingDescription"] = "新增或删除敌对玩家时自动调整窗口大小。"
L["ResizePingLimit"] = "列表限制"
L["ResizePingLimitDescription"] = "限制窗口中显示的敌对玩家数量。"
L["DisplayTooltipNearPingWindow"] = "在Ping窗口附近显示工具提示"
L["DisplayTooltipNearPingWindowDescription"] = "进行设置以在“间谍”窗口附近显示工具提示。"
...
L["Rank"] = "级别"
L["SelectFont"] = "选择字体"
L["SelectFontDescription"] = "为Ping选择字体。"
L["RowHeight"] = "选择列高"
L["RowHeightDescription"] = "为Ping设置列高度。"
L["Texture"] = "质地"
L["TextureDescription"] = "选择Ping窗口的纹理"
...
L["ShareData"] = "与其他Ping用户分享数据"
L["ShareDataDescription"] = "设置与队伍、团队或公会中的其他Ping用户分享数据。"
L["UseData"] = "使用其他Ping用户的数据"
L["UseDataDescription"] = "使用队伍、团队或公会中的其他Ping用户的数据。"
...
L["PingSlashDescription"] = "这些按钮会执行在聊天窗口中输入/ping 命令一样的功能。"
L["Enable"] = "启用"
L["EnableDescription"] = "启用Ping并显示窗口。"
L["Show"] = "显示"
L["ShowDescription"] = "显示Ping主窗口"
L["Hide"] = "隐藏"
L["HideDescription"] = "隐藏主窗口"
L["Reset"] = "重置"
L["ResetDescription"] = "恢复Ping窗口和外观默认设置"
L["ClearSlash"] = "清除"
L["ClearSlashDescription"] = "删除被侦测敌对玩家的列表"
L["Config"] = "配置"
L["ConfigDescription"] = "打开Ping窗口的配置菜单"
L["KOS"] = "KOS即视击杀"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3a警告！ 安装了错误的Ping版本。 Uninstall this version and install the one that matches your current game version。"
L["PingEnabled"] = "|cff9933ffPing 侦测敌方玩家插件已启动。"
L["PingDisabled"] = "|cff9933ffPing 侦测敌方玩家插件已关闭。 输入 |cffffffff/ping show|cff9933ff 启动插件。"
L["UpgradeAvailable"] = "|cff9933ff新版Ping 侦测敌方玩家 已有新的版本。 可以从这里下载新版本：\n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] 侦测到的玩家："
L["KillOnSightDetected"] = "[Ping] 侦测到的KOS敌对玩家："
L["Level"] = "等级"
L["LastSeen"] = "上次遇到"
...
L["DaysAgo"] = "天前"
L["Close"] = "关闭"
L["CloseDescription"] = "|cffffffff隐藏Ping窗口。默认在下次侦测到敌对玩家时显示。"
L["Left/Right"] = "左/右"
L["Left/RightDescription"] = "|cffffffff在附近，最近，忽略和KOS列表切换。"
L["Clear"] = "清除"
L["ClearDescription"] = "|cffffffff清楚已就侦测敌对玩家列表。Ctrl+左键单击以启动或停止 Ping。 按住Shift并单击可打开/关闭声音。"
