local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "esES")
...
L["About"] = "Sobre"
L["PingDescription1"] = [[
Ping es un addon que te alertará sobre la presencia de jugadores enemigos cercanos. Estas son algunas de las características principales.
...
Los jugadores que se añaden a la lista de ignorados no serán reportados por Ping. Puedes añadir y eliminar jugadores a esta lista utilizando el menú desplegable del botón o manteniendo presionada la tecla Control mientras haces clic en el botón.
...
Opciones cuando Ping está activado o desactivado.
]]
L["EnablePing"] = "Activar Ping"
L["EnablePingDescription"] = "Activa o desactiva Ping."
L["EnabledInBattlegrounds"] = "Activar Ping en campos de batalla"
L["EnabledInBattlegroundsDescription"] = "Activa o desactiva Ping cuando estás en un campo de batalla."
L["EnabledInArenas"] = "Activar Ping en arenas"
L["EnabledInArenasDescription"] = "Activa o desactiva Ping cuando estás en una arena."
L["EnabledInWintergrasp"] = "Activar Ping en zonas de combate mundial"
L["EnabledInWintergraspDescription"] = "Activa o desactiva Ping cuando estás en zonas de combate mundial como Lago Conquista de Invierno en Rasganorte."
...
L["DisableWhenPVPUnflagged"] = "Desactivar Ping cuando no estás marcado para JcJ"
L["DisableWhenPVPUnflaggedDescription"] = "Activa o desactiva Ping dependiendo de tu estado de JcJ."
L["DisabledInZones"] = "Desactivar Ping mientras estás en estas ubicaciones"
L["DisabledInZonesDescription"] = "Selecciona ubicaciones donde Ping estará desactivado."
...
Opciones para la ventana de Ping y tooltips.
]]
L["ShowOnDetection"] = "Mostrar Ping cuando se detectan jugadores enemigos"
L["ShowOnDetectionDescription"] = "Establece esto para mostrar la ventana de Ping y la lista de cercanos si Ping está oculto cuando se detectan jugadores enemigos."
L["HidePing"] = "Ocultar Ping cuando no se detectan jugadores enemigos"
L["HidePingDescription"] = "Establece esto para ocultar Ping cuando se muestra la lista de cercanos y esta queda vacía. Ping no se ocultará si limpias la lista manualmente."
...
L["AlphaDescription"] = "Establece la transparencia de la ventana de Ping."
L["AlphaBG"] = "Transparencia en campos de batalla"
L["AlphaBGDescription"] = "Establece la transparencia de la ventana de Ping en campos de batalla."
L["LockPing"] = "Bloquear la ventana"
L["LockPingDescription"] = "Bloquea la ventana de Ping para que no se mueva."
L["ClampToScreen"] = "Limitar la pantalla"
L["ClampToScreenDescription"] = "Controla si la ventana de Ping se puede arrastrar fuera de la pantalla."
L["InvertPing"] = "Invertir la ventana"
L["InvertPingDescription"] = "Voltea la ventana de Ping boca abajo."
L["Reload"] = "Recargar IU"
L["ReloadDescription"] = "Necesario al cambiar la ventana de Ping."
L["ResizePing"] = "Redimensionar la ventana de Ping automáticamente"
L["ResizePingDescription"] = "Establece esto para redimensionar automáticamente la ventana de Ping a medida que se agregan y eliminan jugadores enemigos."
L["ResizePingLimit"] = "Límite de lista"
L["ResizePingLimitDescription"] = "Limita el número de jugadores enemigos mostrados en la ventana de Ping."
L["DisplayTooltipNearPingWindow"] = "Mostrar tooltips cerca de la ventana de Ping"
L["DisplayTooltipNearPingWindowDescription"] = "Establece esto para mostrar tooltips cerca de la ventana de Ping."
...
L["SelectFontDescription"] = "Selecciona una fuente para la ventana de Ping."
L["RowHeight"] = "Seleccionar la altura de fila"
L["RowHeightDescription"] = "Selecciona la altura de fila para la ventana de Ping."
L["Texture"] = "Textura"
L["TextureDescription"] = "Selecciona una textura para la ventana de Ping"
...
L["DisplayOnMapDescription"] = "Muestra iconos en el mapa para la ubicación de otros usuarios de Ping en tu grupo, banda y hermandad cuando detectan enemigos."
...
Opciones sobre cómo Ping mantiene y recopila datos.
]]
...
L["ShareData"] = "Compartir datos con otros usuarios de Ping"
L["ShareDataDescription"] = "Establece esto para compartir los detalles de tus encuentros con jugadores enemigos con otros usuarios de Ping en tu grupo, banda y hermandad."
L["UseData"] = "Usar datos de otros usuarios de Ping"
L["UseDataDescription"] = "Establece esto para usar los datos recopilados por otros usuarios de Ping en tu grupo, banda y hermandad."
...
L["PingSlashDescription"] = "Estos botones ejecutan las mismas funciones que las del comando de barra diagonal /ping."
L["Enable"] = "Activar"
L["EnableDescription"] = "Activa Ping y muestra la ventana principal."
L["Show"] = "Mostrar"
...
L["Config"] = "Configurar"
L["ConfigDescription"] = "Abre la ventana de configuración de Addons de la interfaz para Ping."
L["KOS"] = "MaV"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3a¡Advertencia! La versión incorrecta de Ping está instalada. Uninstall this version and install the one that matches your current game version."
L["PingEnabled"] = "|cff9933ffAddon Ping activado."
L["PingDisabled"] = "|cff9933ffAddon Ping desactivado. Escribe |cffffffff/ping show|cff9933ff para activarlo."
L["UpgradeAvailable"] = "|cff9933ffHay disponible una nueva versión de Ping. Puede descargarse desde:\n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] Jugador detectado: "
L["KillOnSightDetected"] = "[Ping] Jugador en la lista de matar a la vista detectado: "
L["Level"] = "Nivel"
...
L["Close"] = "Cerrar"
L["CloseDescription"] = "|cffffffffOculta la ventana de Ping. Por defecto, se mostrará de nuevo cuando se detecte al próximo jugador enemigo."
...
L["Clear"] = "Limpiar"
L["ClearDescription"] = "|cffffffffLimpia la lista de jugadores detectados. CTRL+Clic activará/desactivará Ping. Mayús+Clic activará/desactivará todos los sonidos."
