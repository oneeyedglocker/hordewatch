local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "koKR")
...
L["About"] = "정보"
L["PingDescription1"] = [[
Ping는 근처에 있는 적 플레이어를 알려주는 애드온 입니다.
...
제외 목록에 포함 된 적 플레이어는 Ping에 기록되지 않습니다. 드롭다운 메뉴 또는 목록을 Ctrl + 좌클릭 으로 플레이어를 제외목록에 추가 / 제거 할 수 있습니다.
...
Ping 가 활성화 또는 비활성화 된 경우에 대한 옵션입니다.
]] 
L["EnablePing"] = "Ping 활성화"
L["EnablePingDescription"] = "Ping 활성화 또는 비활성화."
L["EnabledInBattlegrounds"] = "전장일 때 Ping 활성화"
L["EnabledInBattlegroundsDescription"] = "전장에 있을 때 Ping를 활성화 또는 비활성화 합니다."
L["EnabledInArenas"] = "아레나에 있을 때 Ping 활성화"
L["EnabledInArenasDescription"] = "아레나에 있을 때 Ping를 활성화 또는 비활성화 합니다."
L["EnabledInWintergrasp"] = "대규모 전장일 때 Ping 활성화"
L["EnabledInWintergraspDescription"] = "겨울손아귀 호수와 같은 대규모 전장일 경우 Ping를 활성화 또는 비활성화 합니다."
...
L["DisableWhenPVPUnflagged"] = "PVP 상태가 아닐 때 Ping 비활성화"
L["DisableWhenPVPUnflaggedDescription"] = "PVP 상태일 경우 Ping를 활성화 또는 비활성화 합니다."
...
L["ShowOnDetection"] = "적 플레이어가 탐지될 경우 Ping 창 표시"
L["ShowOnDetectionDescription"] = "Ping 창이 숨겨져 있을 때 적 플레이어가 탐지될 경우 근접한 적 목록을 표시하려면 체크하십시오."
L["HidePing"] = "적 플레이어가 없을 때 Ping 숨기기"
L["HidePingDescription"] = "근접한 적 목록이 비었을 때 Ping 창을 숨기고 싶다면 체크하십시오. 지우기 버튼을 눌러 목록을 비웠을 경우, Ping 창은 숨겨지지 않습니다."
...
L["Alpha"] = "투명도"
L["AlphaDescription"] = "Ping 창의 투명도를 설정하십시오."
L["AlphaBG"] = "전장의 투명성"
L["AlphaBGDescription"] = "전장에서 Ping 창의 투명도를 설정하십시오."
L["LockPing"] = "Ping 창 잠금"
L["LockPingDescription"] = "Ping 창이 움직이지 않도록 고정합니다."
L["ClampToScreen"] = "화면에 고정"
L["ClampToScreenDescription"] = "Ping 창이 화면 밖으로 벗어나지 못하게 합니다"
L["InvertPing"] = "Ping 창 뒤집음"
L["InvertPingDescription"] = "Ping 창을 위아래로 뒤집습니다."
L["Reload"] = "UI 새로고침"
L["ReloadDescription"] = "Ping 창을 변경 하려면 UI 새로고침을 해야합니다."
L["ResizePing"] = "Ping 창 크기 자동조절"
L["ResizePingDescription"] = "적 플레이어가 추가/제거될 때 Ping 창 크기를 자동으로 조절하려면 체크하십시오"
L["ResizePingLimit"] = "목록 갯수 제한"
L["ResizePingLimitDescription"] = "Ping 창에 표시되는 적 플레이어 수 제한."
L["DisplayTooltipNearPingWindow"] = "Ping 창 근처에 툴팁 표시"
L["DisplayTooltipNearPingWindowDescription"] = "Ping 창 근처에 툴팁을 표시하려면 이것을 설정하십시오."
...
L["Rank"] = "등급"
L["SelectFont"] = "폰트 설정"
L["SelectFontDescription"] = "Ping 창의 폰트를 선택하세요."
L["RowHeight"] = "열 높이 설정"
L["RowHeightDescription"] = "Ping 창의 열 높이를 설정하세요."
L["Texture"] = "질감 배경"
L["TextureDescription"] = "Ping 창의 질감을 선택하십시오"
...
Ping 가 데이터를 유지 관리하고 수집하는 방법에 대한 옵션.
]]
...
L["ShareData"] = "다른 Ping 애드온 유저와 데이터 공유"
L["ShareDataDescription"] = "Ping 애드온을 사용하는 파티원, 길드원, 공격대원과 적 플레이어 정보를 공유하려면 체크하십시오."
L["UseData"] = "다른 Ping 애드온 유저의 데이터를 사용"
L["UseDataDescription"] = "Ping 애드온을 사용하는 파티원, 길드원, 공격대원의 적 플레이어 정보를 수집하려면 체크하십시오."
...
L["PingSlashDescription"] = "이 버튼은 /ping 명령어와 동일한 작업을 수행합니다."
L["Enable"] = "활성화"
L["EnableDescription"] = "Ping를 활성화 하고 Ping 창을 띄웁니다."
L["Show"] = "표시"
L["ShowDescription"] = "Ping 창을 띄웁니다."
L["Hide"] = "숨는 장소"
L["HideDescription"] = "메인 윈도우를 숨 깁니다."
L["Reset"] = "초기화"
L["ResetDescription"] = "Ping 창의 외형과 위치를 초기화 합니다."
L["ClearSlash"] = "지우기"
L["ClearSlashDescription"] = "탐지된 적 플레이어의 명단을 지웁니다."
L["Config"] = "설정"
L["ConfigDescription"] = "Ping 애드온 설정창을 엽니다."
L["KOS"] = "살생부"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3a경고! 잘못된 Ping 버전이 설치되었습니다. Uninstall this version and install the one that matches your current game version."
L["PingEnabled"] = "|cff9933ffPing 애드온이 활성화되었습니다.."
L["PingDisabled"] = "|cff9933ffPing 애드온이 비활성화되었습니다. |cffffffff/ping show|cff9933ff 을 입력해 활성화 시키십시오."
L["UpgradeAvailable"] = "|cff9933ffA Ping의 새로운 버전을 사용할 수 있습니다. 다운로드 주소:\n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] 적 플레이어 탐지: "
L["KillOnSightDetected"] = "[Ping] 살생부 명단의 적 탐지: "
L["Level"] = "레벨"
L["LastSeen"] = "마지막 탐지"
...
L["DaysAgo"] = "일 전"
L["Close"] = "닫기"
L["CloseDescription"] = "|cffffffffPing창을 숨깁니다. 기본적으로 적 플레이어가 탐지되면 다시 표시됩니다."
L["Left/Right"] = "왼쪽/오른쪽"
L["Left/RightDescription"] = "|cffffffff근접한 적, 1시간 이내, 제외 목록, 살생부 명단으로 이동합니다."
L["Clear"] = "지우기"
L["ClearDescription"] = "|cffffffff탐지된 적 플레이어 명단을 지웁니다. Ctrl + 왼쪽 클릭으로 Ping 애드온을 중지 / 시작할 수 있습니다. Shift- 클릭은 모든 사운드를 켜거나 끕니다."
