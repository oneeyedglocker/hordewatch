local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "itIT")
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3aAvvertimento! È installata la versione errata di Ping. Uninstall this version and install the one that matches your current game version."
