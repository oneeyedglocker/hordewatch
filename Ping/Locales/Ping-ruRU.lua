local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "ruRU")
...
Настройки для включённого и отключённого состояния Ping.
]]
L["EnablePing"] = "Включить Ping"
L["EnablePingDescription"] = "Включает или отключает SPY."
L["EnabledInBattlegrounds"] = "Включить Ping на полях боя"
L["EnabledInBattlegroundsDescription"] = "Включает или отключает SPY, когда вы находитесь на полях боя."
L["EnabledInArenas"] = "Включить Ping на аренах"
L["EnabledInArenasDescription"] = "Включает или отключает SPY, когда вы находитесь на арене."
L["EnabledInWintergrasp"] = "Активировать Ping в PvP-зонах открытого мира"
...
L["EnabledInSanctuaries"] = "Включить Ping в святилищах"
L["EnabledInSanctuariesDescription"] = "Включает или отключает Ping, когда Вы находитесь в святилище."
...
L["DisabledInZones"] = "Отключать Ping в этих локациях"
L["DisabledInZonesDescription"]	= "Выбрать локации, где Ping будет отключен."
...
L["ShowOnDetection"] = "Отображать Ping при обнаружении вражеских игроков"
...
L["HidePing"] = "Скрывать SPY, когда не обнаружено вражеских игроков"
L["HidePingDescription"] = "Отметьте эту опцию, чтобы скрывать окно SPY, когда отображается список Поблизости и он становится пустым. При этом SPY не будет скрываться, если вы очистите список вручную."
...
L["AlphaDescription"] = "Установите прозрачность окна Ping."
L["AlphaBG"] = "Прозрачность на полях сражений"
L["AlphaBGDescription"] = "Установите прозрачность окна Ping на полях сражений."
L["LockPing"] = "Зафиксировать окно Ping"
L["LockPingDescription"] = "Фиксирует окно SPY, чтобы оно не перемещалось."
L["ClampToScreen"] = "Закрепить окно в пределах Экрана"
L["ClampToScreenDescription"] = "Определяет, можно ли перемещать окно Ping за пределы экрана."
L["InvertPing"] = "Инвертировать окно Ping"
L["InvertPingDescription"] = "Переворачивает окно SPY вверх ногами."
L["Reload"] = "Перезагрузить Интерфейс"
L["ReloadDescription"] = "Требуется при изменении окна Ping."
L["ResizePing"] = "Автоматическое масштабирование окна SPY"
L["ResizePingDescription"] = "Отметьте эту опцию, чтобы автоматически изменять размер окна SPY при добавлении и удалении врагов."
L["ResizePingLimit"] = "Максимум в списке"
L["ResizePingLimitDescription"] = "Ограничить количество вражеских игроков в окне SPY."
L["DisplayTooltipNearPingWindow"] = "Показывать всплывающую подсказку рядом с окном SPY"
L["DisplayTooltipNearPingWindowDescription"] = "Отметьте эту опцию, чтобы отображать всплывающие подсказки рядом с окном SPY."
...
L["SelectFontDescription"] = "Выбрать шрифт для окна Ping."
L["RowHeight"] = "Выбрать Высоту Строки"
L["RowHeightDescription"] = "Выбрать Высоту Строки для окна SPY"
L["Texture"] = "Текстура"
L["TextureDescription"] = "Выбрать текстуру для окна Ping."
...
L["DisplayOnMapDescription"] = "Отображать иконки на карте с местоположением других пользователей Ping из вашей группы, рейда и гильдии при обнаружении ими врагов."
...
Настройки способов сбора и хранения данных в Ping.
]]
...
L["ShareData"] = "Делиться данными с другими пользователями аддона Ping"
L["ShareDataDescription"] = "Отметьте эту опцию, чтобы автоматически делиться информацией о встречах с вражескими игроками с другими пользователями Ping в вашей группе, рейде и гильдии."
L["UseData"] = "Использовать данные других пользователей аддона Ping"
L["UseDataDescription"] = "Отметьте эту опцию, чтобы использовать данные, собранные другими пользователями Ping в вашей группе, рейде и гильдии."
...
L["PingSlashDescription"] = "Эти кнопки выполняют те же функции, что и слэш-команды /SPY"
L["Enable"] = "Включить"
L["EnableDescription"] = "Включает Ping и показывает Главное Окно"
L["Show"] = "Показать"
...
L["Config"] = "Настройки"
L["ConfigDescription"] = "Открыть окно настройки аддона Ping в 'Параметры-Модификации'."
L["KOS"] = "KOS"
...
L["SanctuaryDescription"] = "Показать/Скрыть Ping на территории Святилища."
...
-- Output messages
L["VersionCheck"] = "|cffc41e3aВнимание: Установлена неправильная версия Ping. Удалите эту версию и установите ту, которая соответствует текущей версии игры."
L["PingEnabled"] = "|cff9933ffАддон SPY активирован."
L["PingDisabled"] = "|cff9933ffАддон SPY отключён. Введите |cffffffff/ping show|cff9933ff чтобы включить."
L["UpgradeAvailable"] = "|cff9933ffДоступна новая версия Ping. Скачать её можно по адресу: \n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] Обнаруженный игрок: "
L["KillOnSightDetected"] = "[Ping] Обнаружен игрок Kill On Sight: "
L["Level"] = "Уровень"
...
L["Close"] = "Закрыть"
L["CloseDescription"] = "|cffffffffСкрывает окно Ping. По умолчанию окно снова появится при обнаружении следующего вражеского игрока."
...
L["Clear"] = "Очистить"
L["ClearDescription"] = "|cffffffffОчищает список обнаруженных игроков. Нажатие Ctrl + клик включает/выключает Ping. Нажатие Shift + клик включает/выключает весь звук."
