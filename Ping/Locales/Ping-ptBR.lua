local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "ptBR")
...
L["About"] = "Informação"
L["PingDescription1"] = [[
Ping é um addon que vai alerta-lo da presença de jogadores inimigos nas proximidades. Estas são algumas das principais características.
...
Opções para quando o Ping está ativado ou desativado.
]]
L["EnablePing"] = "Ativar Ping"
L["EnablePingDescription"] = "Ativa ou desativa o Ping."
L["EnabledInBattlegrounds"] = "Ativar Ping em CB"
L["EnabledInBattlegroundsDescription"] = "Ativa ou desativa o Ping em Campos de Batalha."
L["EnabledInArenas"] = "Ativar Ping em Arenas"
L["EnabledInArenasDescription"] = "Ativa ou desativa o Ping em Arenas."
L["EnabledInWintergrasp"] = "Ativar Ping em Zonas de Combate"
L["EnabledInWintergraspDescription"] = "Ativa ou desativa o Ping em locais como Invérnia."
...
L["DisableWhenPVPUnflagged"] = "Desativar Ping quando JxJ estiver desativado"
L["DisableWhenPVPUnflaggedDescription"] = "Ativa ou desativa o Ping dependendo se o seu status de JxJ estiver ativado ou desativado."
L["DisabledInZones"] = "Desative o Ping enquanto estiver nesses locais"
L["DisabledInZonesDescription"]	= "Selecione locais onde o Ping será desativado"
...
Opções para a janela Ping e dicas de ferramentas.
]]
L["ShowOnDetection"] = "Mostrar Ping quando um inimigo for detectado"
L["ShowOnDetectionDescription"] = "Marque isso para que o Ping mostre a lista de Proximidades quando um inimigo for detectado."
L["HidePing"] = "Esconder Ping quando nenhum inimigo for detectado"
L["HidePingDescription"] = "Marque isso para que o Ping seja escondido quando a lista de Proximidades estiver sendo mostrada e ficar vazia. Ping não será escondido se você limpar a lista manualmente."
...
L["AlphaDescription"] = "Defina a transparência da janela Ping."
L["AlphaBG"] = "Transparência em CB"
L["AlphaBGDescription"] = "Defina a transparência da janela Ping nos Campos de Batalha."
L["LockPing"] = "Travar a janela do Ping"
L["LockPingDescription"] = "Trava a janela para que ela não possa ser movida."
L["ClampToScreen"] = "Limitar na Tela"
L["ClampToScreenDescription"] = "Controla quando a janela do Ping pode ser arrastada para fora da tela."
L["InvertPing"] = "Inverter a janela de Ping"
L["InvertPingDescription"] = "Inverte a janela de Ping de cabeça para baixo."
L["Reload"] = "Recarregar IU"
L["ReloadDescription"] = "Necessário ao alterar a janela do Ping."
L["ResizePing"] = "Redimensionar janela do Ping automaticamente"
L["ResizePingDescription"] = "Marque isso para que a janela do Ping seja redimensionada a medida que novos jogadores são adicionados ou removidos."
L["ResizePingLimit"] = "Limite de lista"
L["ResizePingLimitDescription"] = "Limite o número de jogadores inimigos mostrados na janela do Ping."
L["DisplayTooltipNearPingWindow"] = "Mostrar dica de ferramenta perto da janela do Ping"
L["DisplayTooltipNearPingWindowDescription"] = "Defina isso para Mostrar dicas de ferramentas perto da janela do Ping."
...
L["SelectFontDescription"] = "Selecione um tipo de letra para a janela Ping."
L["RowHeight"] = "Selecione a altura da linha"
L["RowHeightDescription"] = "Selecione a altura da linha para a janela Ping."
L["Texture"] = "Textura"
L["TextureDescription"] = "Selecione a textura da janela Ping"
...
Você pode configurar como o Ping adiciona e remove inimigos da lista de Proximidades.
]]
...
Opções sobre como o Ping mantém e reúne dados.
]]
...
L["ShareData"] = "Compartilhar dados com outros usuários do Ping"
L["ShareDataDescription"] = "Marque isso para compartilhar os dados dos inimigos encontrados com outros usuários do Ping em seu grupo, raide e guilda."
L["UseData"] = "Usar dados de outros usuários do Ping"
L["UseDataDescription"] = "Marque isso para usar dados coletados por outros usuários do Ping em seu grupo, raide e guilda."
...
L["PingSlashDescription"] = "Esses botões executam as mesmas funções que aquelas vistas no slash command /ping"
L["Enable"] = "Enable"
L["EnableDescription"] = "Permite que o Ping e mostra a janela principal."
L["Show"] = "Mostrar"
...
L["Config"] = "Config"
L["ConfigDescription"] = "Abre a janela de configuração do Ping."
L["KOS"] = "Lista Negra"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3aAtenção! A versão errada do Ping está instalada. Uninstall this version and install the one that matches your current game version."
L["PingEnabled"] = "|cff9933ffPing addon ativado."
L["PingDisabled"] = "|cff9933ffPing addon desativado. Digite |cffffffff/ping show|cff9933ff para ativar."
L["UpgradeAvailable"] = "|cff9933ffA nova versão do Ping está disponivel. Baixe-o em:\n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] Jogador Detectado: "
L["KillOnSightDetected"] = "[Ping] Jogador na Lista Negra detectado: "
L["Level"] = "Level"
L["LastSeen"] = "Visto há"
...
L["Close"] = "Fechar"
L["CloseDescription"] = "|cffffffffEsconde a janela do Ping. Por defeito ela irá ser mostrada novamante quando um jogador inimigo for detectado."
...
L["Clear"] = "Limpar"
L["ClearDescription"] = "|cffffffffLimpa a lista de inimigos detectados. Ctrl e click Inicia / Para  o Ping. Shift e Click liga / desliga todo o som."
