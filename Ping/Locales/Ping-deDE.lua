local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "deDE")
...
L["About"] = "Info"
L["PingDescription1"] = [[
Ping ist ein Addon, das Sie über das Vorhandensein von, in der Nähe befindlichen, feindlichen Spielern benachrichtigt. Dies sind einige der Hauptmerkmale
...
Spieler, die der Ignorierliste hinzugefügt werden, werden nicht vom Ping gemeldet. Mithilfe des Dropdown-Menüs der Schaltfläche oder Halten der STRG-Taste beim Klicken auf die Schaltfläche können Sie Spieler zu der Liste hinzufügen oder entfernen.
...
Optionen für die Aktivierung oder Deaktivierung von Ping.
]]
L["EnablePing"] = "Aktiviert Ping"
L["EnablePingDescription"] = "Aktiviert oder deaktiviert Ping."
L["EnabledInBattlegrounds"] = "Aktiviert Ping in Schlachtfeldern"
L["EnabledInBattlegroundsDescription"] = "Aktiviert oder deaktiviert Ping, wenn Sie in einer Arena sind."
L["EnabledInArenas"] = "Aktiviert Ping in Arenen"
L["EnabledInArenasDescription"] = "Aktiviert oder deaktiviert Ping, wenn Sie in einer Arena sind."
L["EnabledInWintergrasp"] = "Aktiviert Ping in Kampfgebieten der Welt"
L["EnabledInWintergraspDescription"] = "Aktiviert oder deaktiviert Ping, wenn Sie in Kampfgebieten der Welt, wie z.B. Wintergrasp in Northrend, sind."
L["EnabledInSanctuaries"] = "Aktiviert SPY in Schutzgebieten."
L["EnabledInSanctuariesDescription"] = "Aktiviert oder deaktiviert Ping, wenn Sie in einer Schutzgebieten."
L["DisableWhenPVPUnflagged"] = "Deaktiviert Ping, wenn PVP nicht eingeschaltet ist"
L["DisableWhenPVPUnflaggedDescription"] = "Aktiviert oder deaktiviert Ping, abhängig von Ihrem PVP-Status."
...
Optionen für das Ping-Fenster und QuickInfos.
]]
L["ShowOnDetection"] = "Blendet Ping ein, wenn feindliche Spieler erkannt werden"
L["ShowOnDetectionDescription"] = "Wählen Sie diese Einstellung, um das Ping-Fenster und In der Nähe-Liste anzuzeigen, wenn Ping verborgen ist und feindliche Spieler erkannt werden."
L["HidePing"] = "Ping ausblenden, wenn keine feindlichen Spieler erkannt werden"
L["HidePingDescription"] = "Wählen Sie diese Einstellung, um Ping auszublenden, wenn die In der Nähe-Liste angezeigt wird und leer wird. Ping wird nicht ausgeblendet, wenn Sie die Liste manuell löschen."
...
L["LockPing"] = "Sperrt das Ping-Fenster"
L["LockPingDescription"] = "Fixiert das Ping-Fenster an einem Ort, so dass es sich nicht bewegt."
L["ClampToScreen"] = "Auf dem Bildschirm halten"
L["ClampToScreenDescription"] = "Kontrolliert, ob das Ping-Fenster über die Bildschirmkanten hinaus verschoben werden kann."
L["InvertPing"] = "Dreht das Ping-Fenster um"
L["InvertPingDescription"] = "Kippt das Ping-Fenster verkehrt herum."
L["Reload"] = "Neu laden UI"
L["ReloadDescription"] = "Erforderlich beim Wechseln des SPY-Fenster."
L["ResizePing"] = "Adaptiert die Größe des Ping-Fensters automatisch."
L["ResizePingDescription"] = "Wählen Sie diese Einstellung, um die Größe des Ping-Fensters automatisch anzupassen, wenn feindliche Spieler hinzugefügt oder entfernt werden."
L["ResizePingLimit"] = "Listenlimit"
L["ResizePingLimitDescription"] = "Begrenzen Sie die Anzahl der im Ping-Fenster angezeigten gegnerischen Spieler."
L["DisplayTooltipNearPingWindow"] = "Tooltip in der Nähe des Ping-Fensters anzeigen"
L["DisplayTooltipNearPingWindowDescription"] = "Stellen Sie dies ein, um Tooltips in der Nähe des Ping-Fensters anzuzeigen."
...
L["SelectFontDescription"] = "Wählen Sie eine Schriftart für das Ping-Fenster."
L["RowHeight"] = "Wählen Sie die Zeilenhöhe aus"
L["RowHeightDescription"] = "Wählen Sie die Zeilenhöhe für das Ping-Fenster aus."
L["Texture"] = "Textur"
...
L["DisplayOnMapDescription"] = "Zeigen Sie Kartensymbole für die Position anderer Ping-Benutzer in Ihrer Gruppe, Schlachtzug und Gilde an, wenn sie Feinde erkennen."
...
Optionen, wie Ping Daten verwaltet und sammelt.
]]
...
L["ShareData"] = "Teile die Daten mit anderen Ping-Benutzern."
L["ShareDataDescription"] = "Stellt ein, dass Details Ihrer feindlichen Spieler-Begegnungen mit anderen Ping-Benutzern Ihrer Gruppe und Gilde geteilt werden."
L["UseData"] = "Verwende Daten anderer Ping-Benutzer."
L["UseDataDescription"] = "Stelle dies ein, um gesammelte Daten anderer Ping-Benutzer Ihrer Gruppe und Gilde zu verwenden."
...
L["PingSlashDescription"] = "Diese Schaltflächen führen die gleichen Funktionen aus, wie die in den Slash Befehl /ping"
L["Enable"] = "Aktivieren"
L["EnableDescription"] = "Aktiviert Ping und zeigt das Hauptfenster."
L["Show"] = "Zeigen"
...
L["ConfigDescription"] = "Öffnet das Interface-Konfigurationsfenster für Ping."
L["KOS"] = "KOS"
...
--Ausgabemeldungen
L["VersionCheck"] = "|cffc41e3aWarnung! Die falsche Version von Ping ist installiert. Uninstall this version and install the one that matches your current game version."
L["PingEnabled"] = "|cff9933ffPing-Addon aktiviert."
L["PingDisabled"] = "|cff9933ffPing-Addon deaktiviert. Tippen Sie |cffffffff/ping show|cff9933ff um es zu aktivieren."
L["UpgradeAvailable"] = "|cff9933ffEine neue Version von Ping ist verfügbar. Es kann von: \n| cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc heruntergeladen werden."
...
L["PlayerDetected"] = "[Ping] Spieler erkannt:"
L["KillOnSightDetected"] = "[Ping] Sofort zu tötenden Spieler erkannt:"
L["Level"] = "Level"
...
L["DaysAgo"] = "vor Tagen"
L["Close"] = "Schließen"
L["CloseDescription"] = "|cffffffffVerbirgt das Ping-Fenster. Es wird standardmäßig wieder gezeigt, wenn der nächste feindliche Spieler erkannt wird."
...
L["Clear"] = "Löschen"
L["ClearDescription"] = "|cffffffffLöscht die Liste der Spieler, die gefunden wurden. Strg-Klick stoppt/startet Ping. Shift-Click schaltet den Ton ein / aus."
