local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "zhTW") -- Traditional Chinese
...
L["Ping"] = "偵測敵方玩家 Ping"
L["Version"] = "版本"
L["Ping Option"] = "PVP 偵測敵方玩家"
L["Profiles"] = "設定檔"

-- About
L["About"] = "信息"
L["PingDescription1"] = [[
Ping 是一個可以警告你附近有敵方玩家出沒的插件。這些是一些主要功能。
...
Ping 不會顯示被加入到忽略清單中的玩家。透過滑鼠右鍵選單，或是按住 CTRL 鍵點擊名字將玩家加入清單和移除。
...
L["EnablePing"] = "啟用"
L["EnablePingDescription"] = "啟用或禁用 Ping。"
L["EnabledInBattlegrounds"] = "戰場中啟用"
L["EnabledInBattlegroundsDescription"] = "身處在戰場中時啟用或停用 Ping。"
L["EnabledInArenas"] = "競技場中啟用"
L["EnabledInArenasDescription"] = "身處在競技場中時啟用或停用 Ping。"
L["EnabledInWintergrasp"] = "世界戰鬥區域中啟用"
L["EnabledInWintergraspDescription"] = "身處在世界戰鬥區中時啟用或停用 Ping，例如北裂境的冬握湖。"
...
L["DisableWhenPVPUnflaggedDescription"] = "依據自身的 PVP 狀態啟用或停用 Ping。"
L["DisabledInZones"] = "在這些位置時禁用Ping"
L["DisabledInZonesDescription"]	= "選擇將禁用Ping的位置。"
L["Booty Bay"] = "藏宝海湾"
L["Everlook"] = "永望镇"						
L["Gadgetzan"] = "加基森"
L["Ratchet"] = "棘齿城"
...
L["ShowOnDetectionDescription"] = "偵測到敵方玩家時會自動將隱藏的 Ping 視窗和附近清單顯示出來。"
L["HidePing"] = "沒有偵測到敵方玩家時隱藏"
L["HidePingDescription"] = "附近清單內容是空的時候會自動隱藏。手動清空清單時不會隱藏 Ping。"
...
L["Alpha"] = "透明度"
L["AlphaDescription"] = "設置Ping窗口的透明度。"
L["AlphaBG"] = "戰場上的透明度"
L["AlphaBGDescription"] = "在戰場中設置Ping窗口的透明度"
L["LockPing"] = "鎖定視窗"
L["LockPingDescription"] = "鎖定 Ping 視窗讓它不能被移動。"
L["ClampToScreen"] = "螢幕鎖定"
L["ClampToScreenDescription"] = "控制是否可以将SPY窗口拖出屏幕。"
L["InvertPing"] = "翻轉視窗"
L["InvertPingDescription"] = "上下翻轉 Ping 視窗。"
L["Reload"] = "重新加载UI"
L["ReloadDescription"] = "需要更改 Ping 窗口."
L["ResizePing"] = "自動調整視窗大小"
L["ResizePingDescription"] = "新增和移除敵方玩家時自動調整 Ping 視窗的大小。"
L["ResizePingLimit"] = "列表限制"
L["ResizePingLimitDescription"] = "限制Ping窗口中显示的敌方玩家数量。"
L["DisplayTooltipNearPingWindow"] = "在Ping窗口附近顯示工具提示"
L["DisplayTooltipNearPingWindowDescription"] = "設置此項以在“間諜”窗口附近顯示工具提示。"
...
L["Rank"] = "會階"
L["SelectFont"] = "選擇字體"
L["SelectFontDescription"] = "選擇 Ping 視窗使用的字體。"
L["RowHeight"] = "選擇列高"
L["RowHeightDescription"] = "選擇 Ping 視窗橫列的高度。"
L["Texture"] = "質地"
L["TextureDescription"] = "選擇 Ping 窗口的紋理"
...
L["WarnRaceNote"] = "注意: 至少需要將敵人選取為目標一次 (點 Ping 視窗中的玩家名字) 他的種族才會加入到資料庫中，下次偵測到時便可以發出警告音效。和偵測附近敵人一樣，戰鬥中無法點選。"
...
L["ShareData"] = "和其他 Ping 使用者分享資料"
L["ShareDataDescription"] = "和隊伍、團隊和公會中也有使用 Ping 插件的玩家分享你遇到敵方玩家的詳情。"
L["UseData"] = "使用來自於其他 Ping 使用者的資料"
L["UseDataDescription"] = "使用從隊伍、團隊和公會中也有使用 Ping 插件的玩家收集到的資料。"
...
L["PingSlashDescription"] = "這些按鈕會執行在聊天視窗輸入 /ping 時相同的指令選項動作。"
L["Enable"] = "啟用"
L["EnableDescription"] = "啟用 Ping 並顯示主視窗。"
L["Show"] = "顯示"
...
L["Config"] = "設定"
L["ConfigDescription"] = "開啟介面 > 插件中的 Ping 設定選項。"
L["KOS"] = "即殺"
...
-- Output messages
L["VersionCheck"] = "|cffc41e3a警告！ 安裝了錯誤的Ping版本。 Uninstall this version and install the one that matches your current game version。"
L["PingEnabled"] = "|cff9933ff偵測敵方玩家插件已啟用。"
L["PingDisabled"] = "|cff9933ff偵測敵方玩家插件已停用，輸入 |cffffffff/ping show|cff9933ff 來啟用。"
...
L["PlayerDetected"] = "[Ping] 偵測到玩家："
L["KillOnSightDetected"] = "[Ping] 偵測到即殺玩家："
L["Level"] = "等級"
L["LastSeen"] = "上次遇到"
...
L["DaysAgo"] = "天前"
L["Close"] = "關閉"
L["CloseDescription"] = "|cffffffff隱藏 Ping 主視窗。預設下次偵測到敵方玩家時會再次顯示。."
L["Left/Right"] = "左 / 右"
L["Left/RightDescription"] = "|cffffffff切換顯示附近、最近、忽略和即殺清單。"
L["Clear"] = "清空"
L["ClearDescription"] = "|cffffffff清空已經偵測到的玩家清單。Ctrl+左键单击将开始/停止 Ping。 按住Shift並單擊可打開/關閉聲音。"
