...
L["Alpha"] = "Window opacity"
L["AlphaDescription"] = "Fades the whole window, text included. Use Panel opacity above if you only want to see through the background."
...
L["MassFightsDescription"] = "\nWhat floats to the top of the list, and what is hidden from it. Matters most in a big fight, where hundreds of detections a minute pass through a few rows.\n"
...
L["HealerEdgeColor"] = "Healer edge color"
...
L["BackgroundOpacity"] = "Panel opacity"
L["BackgroundOpacityDescription"] = "How solid the panel behind the list is. Only the panel fades - names, levels and icons stay fully readable."
L["TitleBarStyle"] = "Style"
...
L["TitleBarColor"] = "Bar color"
L["TitleBarColorDescription"] = "Color of the solid title strip."
L["TitleTextColor"] = "Text color"
L["TitleTextColorDescription"] = "Color and opacity of the window title - the NEARBY text. Drag the opacity slider down to fade it."
L["TitleBarOpacity"] = "Bar opacity"
...
L["ThemeRevert"] = "Undo theme"
L["ThemeRevertDescription"] = "Puts back the colors and window settings you had before the last theme was applied. One step only."
L["LockFont"] = "Keep my font when changing themes"
L["LockFontDescription"] = "Artwork themes normally bring their own font. With this on, Ping puts back the font you chose under Rows every time you change theme. Turning it on now adopts the font showing right now as yours."
L["CustomThemesHeader"] = "Saved themes"
L["CustomThemeName"] = "Name"
L["CustomThemeNameDescription"] = "What to call the theme you are about to save."
L["CustomThemeSave"] = "Save current look as a theme"
L["CustomThemeSaveDescription"] = "Stores every color you have set, the class bar colors, the font, bar texture and window settings under this name. It then appears in the theme list."
L["CustomThemeDelete"] = "Delete this saved theme"
L["CustomThemeDeleteDescription"] = "Removes the saved theme you are currently using. Your colors are left alone."
L["CustomThemeDeleteConfirm"] = "Delete this saved theme? The look you are using now stays; only the saved copy goes."
L["CustomThemeExport"] = "Export to code"
L["CustomThemeExportDescription"] = "Puts a shareable code for the saved theme you are using into the box below."
L["CustomThemeImport"] = "Import from code"
L["CustomThemeImportDescription"] = "Reads a theme code from the box below and adds it to your saved themes. Never overwrites an existing name."
L["CustomThemeCode"] = "Theme code"
L["CustomThemeCodeDescription"] = "Paste a theme code here to import, or export to fill it."
L["CustomThemeSaved"] = "Saved theme: %s"
L["CustomThemeDeleted"] = "Deleted theme: %s"
L["CustomThemeNeedsName"] = "Give the theme a name first."
L["CustomThemeNoneSelected"] = "Pick one of your saved themes first."
L["CustomThemeExported"] = "Exported \"%s\": %d characters. Copy the box below."
L["CustomThemeImported"] = "Imported theme: %s"
L["CustomThemeImportedName"] = "Imported theme"
L["CustomThemeNoCode"] = "Paste a theme code into the box first."
L["CustomThemeBadCode"] = "|cffff4040That is not a valid Ping theme code.|r"
L["BorderHeader"] = "Border"
L["RowEdgeHeader"] = "Row edge"
L["LockingHeader"] = "Locking"
L["ChromeColors"] = "Icons on this bar"
