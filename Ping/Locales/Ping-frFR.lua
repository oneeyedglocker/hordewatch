local L = LibStub("AceLocale-3.0"):NewLocale("Ping", "frFR")
...
L["About"] = "Info"
L["PingDescription1"] = [[
Ping est un addon qui vous avertit de la présence de joueurs ennemis à proximité. Ce sont quelques-unes des principales caractéristiques.
...
Les joueurs qui sont ajoutés à la liste d'ignorés ne seront pas signalés par Ping. Vous pouvez ajouter et supprimer des joueurs de cette liste en utilisant le menu déroulant du bouton ou en maintenant la touche Ctrl enfoncée tout en cliquant sur le bouton.
...
Options lorsque Ping est activé ou désactivé.
]]
L["EnablePing"] = "Activer Ping"
L["EnablePingDescription"] = "Active ou désactive Ping."
L["EnabledInBattlegrounds"] = "Activer Ping en champs de bataille"
L["EnabledInBattlegroundsDescription"] = "Active ou désactive Ping lorsque vous êtes sur un champ de bataille."
L["EnabledInArenas"] = "Activer Ping en arènes"
L["EnabledInArenasDescription"] = "Active ou désactive Ping lorsque vous êtes dans une arène."
L["EnabledInWintergrasp"] = "Activer Ping en zone de combat mondiale"
L["EnabledInWintergraspDescription"] = "Active ou désactive Ping lorsque vous êtes dans des zones de combat mondial comme le Joug-d’Hiver en Northrend."
...
L["DisableWhenPVPUnflagged"] = "Désactiver Ping lorsque le mode JcJ est désactiver"
L["DisableWhenPVPUnflaggedDescription"] = "Active ou désactive Ping en fonction de votre statut JcJ."
L["DisabledInZones"] = "Désactivez Ping lorsque vous vous trouvez dans ces emplacements"
L["DisabledInZonesDescription"]	= "Sélectionnez les emplacements où Ping sera désactivé"
...
Options pour la fenêtre Ping et les infobulles.
]]
L["ShowOnDetection"] = "Afficher Ping lorsque des joueurs ennemis sont détectés"
L["ShowOnDetectionDescription"] = "Choisir cette option pour afficher la fenêtre Ping et la liste des ennemis proches si Ping est masqué lorsque des joueurs ennemis sont détectés."
L["HidePing"] = "Cacher Ping quand aucun ennemi est détecté"
L["HidePingDescription"] = "Choisir cette option pour masquer Ping lorsque la liste des ennemis proches s'affiche et qu'elle devient vide. Ping ne sera pas caché si vous effacez la liste manuellement."
...
L["AlphaDescription"] = "Définissez la transparence de la fenêtre Ping."
L["AlphaBG"] = "Transparence sur les champs de bataille"
L["AlphaBGDescription"] = "Définissez la transparence de la fenêtre Ping sur les champs de bataille."
L["LockPing"] = "Verrouillez la fenêtre Ping"
L["LockPingDescription"] = "Verrouille la fenêtre Ping pour qu'elle ne bouge pas."
L["ClampToScreen"] = "Garder à l'écran"
L["ClampToScreenDescription"] = "Contrôle si la fenêtre Ping peut être déplacée hors écran."
L["InvertPing"] = "Inverser la fenêtre Ping"
L["InvertPingDescription"] = "Renverse la fenêtre Ping"
L["Reload"] = "Recharger IU"
L["ReloadDescription"] = "Requis lors du changement de la fenêtre Ping."
L["ResizePing"] = "Redimensionner la fenêtre Ping automatiquement"
L["ResizePingDescription"] = "Choisir cette option pour redimensionner automatiquement la fenêtre Ping au fur et à mesure que les joueurs ennemis sont ajoutés et supprimés."
L["ResizePingLimit"] = "Limite de liste"
L["ResizePingLimitDescription"] = "Limite le nombre de joueurs ennemis affichés dans la fenêtre Ping."
L["DisplayTooltipNearPingWindow"] = "Afficher l'infobulle près de la fenêtre Ping"
L["DisplayTooltipNearPingWindowDescription"] = "Choisir cette option pour afficher des infobulles près de la fenêtre Ping."
...
L["SelectFontDescription"] = "Sélectionnez une police pour la fenêtre Ping."
L["RowHeight"] = "Sélectionner la hauteur de ligne"
L["RowHeightDescription"] = "Sélectionnez la hauteur de ligne pour la fenêtre Ping."
L["Texture"] = "Texture"
...
L["DisplayOnMapDescription"] = "Affichez les icônes de la carte pour localiser les autres utilisateurs Ping de votre groupe / raid / guilde lorsqu'ils détectent des ennemis."
...
Options sur la façon dont Ping maintient et recueille les données.
]]
...
L["ShareData"] = "Partager des données avec d'autres utilisateurs de Ping"
L["ShareDataDescription"] = "Choisissez cette option pour partager les détails de vos rencontres avec des joueurs ennemis avec d'autres utilisateurs Ping de votre groupe, de votre raid et de votre guilde."
L["UseData"] = "Utiliser les données d'autres utilisateurs de Ping"
L["UseDataDescription"] = "Choisir cette option pour utiliser les données collectées par d'autres utilisateurs de Ping dans votre groupe, raid et guilde."
...
L["PingSlashDescription"] = "Ces boutons exécutent les mêmes fonctions que celles de la commande /ping"
L["Enable"] = "Activer"
L["EnableDescription"] = "Active Ping et affiche la fenêtre principale."
L["Show"] = "Afficher"
L["ShowDescription"] = "SAffichez la fenêtre Ping."
L["Hide"] = "Cacher"
...
L["Config"] = "Config"
L["ConfigDescription"] = "Ouvre la fenêtre de configuration de Ping"
L["KOS"] = "TAV"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3aAttention! La mauvaise version de Ping est installée. Uninstall this version and install the one that matches your current game version."
L["PingEnabled"] = "|cff9933ffAddon Ping activé"
L["PingDisabled"] = "|cff9933ffAddon Ping désactivé. Taper |cffffffff/ping show|cff9933ff pour l'activer"
L["UpgradeAvailable"] = "|cff9933ffUne nouvelle version de Ping est disponible. Elle peut être téléchargée à partir de:\n|cffffffffhttps://www.curseforge.com/wow/addons/spy-tbc"
...
L["PlayerDetected"] = "[Ping] Joueur détecté: "
L["KillOnSightDetected"] = "[Ping] Joueur Tuer à vue détecté: "
L["Level"] = "Niveau"
...
L["Clear"] = "Effacer"
L["ClearDescription"] = "|cffffffffEfface la liste des joueurs qui ont été détectés. Control-Click activera ou désactivera Ping. Shift-Click activera ou désactivera tous les sons."
