...
L["DebugStatusButtonDescription"] = "Print a one-line summary in chat: how many errors, arrow samples and level guesses have been collected so far."
...
L["TGlow"] = "Target Glow"
L["GlowIntro"] = "Marks the nameplate of the player you are tracking, so you can tell which of forty nameplates is the one you clicked. It attaches to the game's own nameplate frame, so it works the same with any nameplate addon - or none. No nameplate means no glow: marking the wrong player is worse than marking nobody."
L["GlowEnabled"] = "Glow the tracked player's nameplate"
L["GlowEnabledDescription"] = "Draw a halo around the nameplate of whoever you are tracking. Works independently of the arrow, so you can use one without the other."
L["GlowDriver"] = "Nameplates are currently being drawn by: %s"
L["GlowPreview"] = "Preview in the middle of the screen"
L["GlowPreviewDescription"] = "Parks the glow in the centre of the screen so you can size and colour it without hunting for an enemy. Click again to put it back to work."
L["GlowSizeHeader"] = "Size and position"
L["GlowWidth"] = "Width"
L["GlowHeight"] = "Height"
L["GlowOffsetX"] = "Horizontal offset"
L["GlowOffsetY"] = "Vertical offset"
L["GlowOffsetDescription"] = "Nudge the glow to line up with your nameplate addon's health bar, which may not sit exactly on the game's anchor point."
L["GlowLookHeader"] = "Appearance"
L["GlowColor"] = "Glow colour"
L["GlowUseClassColor"] = "Use their class colour"
L["GlowUseClassColorDescription"] = "Colour the glow by the tracked player's class instead of the fixed colour above. Falls back to the fixed colour when the class is not known."
L["GlowAlpha"] = "Opacity"
L["GlowAdditive"] = "Blend as light (off = blend as paint)"
L["GlowAdditiveDescription"] = "Additive blending glows brighter over dark backgrounds and is easier to pick out in a crowd. Turn it off for a flatter, more solid outline that stays readable over bright ground."
L["GlowPulse"] = "Pulse"
L["GlowPulseDescription"] = "Fade the glow in and out. Movement catches the eye against a screen full of nameplates that are themselves moving."
L["GlowPulseSpeed"] = "Pulse duration (seconds)"
L["GlowPulseSpeedDescription"] = "Seconds for one half of the pulse. Lower is faster."
L["GlowPulseDepth"] = "Pulse depth"
L["GlowPulseDepthDescription"] = "How far the glow fades at the bottom of the pulse. Lower fades further."
L["GlowPreviewOn"] = "glow preview parked in the centre of the screen - click the button again to stop."
