...
L["DistanceIntro"] = "How far away the game will tell you an enemy exists. Both of these ship well below their maximum, and in world PvP the difference is spotting a group forming rather than walking into it. Spy raises each to the highest value your client accepts, and never lowers one another addon has already set higher."
L["MaxNameplateDistance"] = "Maximum nameplate distance"
L["MaxNameplateDistanceDescription"] = "Push nameplateMaxDistance as high as the client allows, so enemy nameplates appear at the furthest possible range. Re-applied on login and on zone change, because other addons write this too and the last write wins."
...
L["MaxViewDistance"] = "Maximum view distance"
L["MaxViewDistanceDescription"] = "Push farclip as high as the client allows, so the world - and the players standing in it - is drawn as far out as possible. Costs frame rate on a weak machine; that is the trade."
...
L["StrictHealerDetectionDescription"] = "Mark a player as a healer only when they cast an actual healing spell from one of the four healing classes - Healing Touch, Flash of Light, Chain Heal, Greater Heal and so on. Bandages, potions, food, healthstones, life leech, Judgement of Light and every other incidental heal are ignored, because they say nothing about whether somebody is a healer. Turn this off to fall back to the older, looser rule that counts anything healing another player except a list of known exceptions."
L["HealerMinHeals"] = "Healing spells needed"
L["HealerMinHealsDescription"] = "How many healing spells Spy must see before marking someone. A single heal above the size below marks them immediately regardless. Raise this if an off-spec throwing out the occasional heal is still getting flagged."
